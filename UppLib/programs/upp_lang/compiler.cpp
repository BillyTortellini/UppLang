...
void compiler_reset_data(bool keep_data_for_incremental_compile, Compile_Type compile_type)
{
    ...
    compiler_switch_timing_task(Timing_Task::RESET);
    {
        ...
        // Predefined ids
        {
            ...
            ids.upp_operator_enum_values[(int)Upp_Operator::SUBTRACTION] = add_id("SUBTRACTION");
            ids.upp_operator_enum_values[(int)Upp_Operator::DIVISION] = add_id("DIVISION");
            ids.upp_operator_enum_values[(int)Upp_Operator::MULTIPLICATION] = add_id("MULTIPLICATION");
            ids.upp_operator_enum_values[(int)Upp_Operator::MODULO] = add_id("MODULO");
            ids.upp_operator_enum_values[(int)Upp_Operator::EQUAL] = add_id("EQUAL");
            ids.upp_operator_enum_values[(int)Upp_Operator::NOT_EQUAL] = add_id("NOT_EQUAL");
            ids.upp_operator_enum_values[(int)Upp_Operator::LESS_THAN] = add_id("LESS_THAN");
            ids.upp_operator_enum_values[(int)Upp_Operator::LESS_EQUAL] = add_id("LESS_EQUAL");
            ids.upp_operator_enum_values[(int)Upp_Operator::GREATER_EQUAL] = add_id("GREATER_EQUAL");
            ...
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::SUBTRACTION] = add_id("-");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::DIVISION] = add_id("*");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::MULTIPLICATION] = add_id("/");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::MODULO] = add_id("%");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::EQUAL] = add_id("==");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::NOT_EQUAL] = add_id("!=");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::LESS_THAN] = add_id("<");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::LESS_EQUAL] = add_id("<=");
            ids.upp_operator_corresponding_tokens[(int)Upp_Operator::GREATER_EQUAL] = add_id(">=");
