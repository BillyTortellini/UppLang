...
void syntax_editor_render_block(Syntax_Block* block, int indentation, int* line_index)
{
    ...
    if (indentation != 0) {
        ...
        vec2 start = text_to_screen_coord(start_line, (indentation - 1) * 4) + offset;
        vec2 end = text_to_screen_coord(*line_index, (indentation - 1) * 4) + offset;
